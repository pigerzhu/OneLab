...
> OneLab has left beta. The current stable release is 1.3.
>
...
1. Download and install the APK. [OneLab 1.3 APK](https://github.com/pigerzhu/OneLab/releases/download/v1.3/OneLab-v1.3.apk)

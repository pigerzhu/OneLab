...
> OneLab 已結束 Beta 階段，目前正式版本為 1.2。
>
...
OneLab 支援簡體中文、繁體中文、English 和 한국어。Android 13 及以上系統可以透過
...
1. 下載並安裝 APK。[OneLab 1.2 APK](https://github.com/pigerzhu/OneLab/releases/download/v1.2/OneLab-v1.2.apk)

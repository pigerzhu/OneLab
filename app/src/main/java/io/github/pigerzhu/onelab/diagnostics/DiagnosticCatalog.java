...
final class DiagnosticCatalog {
    static final Feature[] FEATURES = {
            ...
            feature("apps.bilibili_in_fold", "Bilibili International large-screen support",
                    SettingsKeys.KEY_ENABLE_BILI_IN_FOLD_GATE, "com.bilibili.app.in"),
            feature("apps.bilibili_in_tablet_layout", "Bilibili International tablet layout",
            ...
            feature("window.refresh_rate_screen_outer", "Cover display refresh-rate range",
                    SettingsKeys.KEY_ENABLE_REFRESH_RATE_SCREEN_OUTER),
            feature("system_ui.recents_layout_per_display",
                    "Per-display recent-app layout",
    ...
    static final Value[] VALUES = {
            ...
            value("display.refresh_rate_screen_inner_min",
                    SettingsKeys.KEY_REFRESH_RATE_SCREEN_INNER_MIN),
            value("display.refresh_rate_screen_inner_max",
                    SettingsKeys.KEY_REFRESH_RATE_SCREEN_INNER_MAX),
            value("display.refresh_rate_screen_outer_min",
                    SettingsKeys.KEY_REFRESH_RATE_SCREEN_OUTER_MIN),
            value("display.refresh_rate_screen_outer_max",
                    SettingsKeys.KEY_REFRESH_RATE_SCREEN_OUTER_MAX),
            value("display.refresh_rate_screen_runtime_status",
                    SettingsKeys.KEY_REFRESH_RATE_SCREEN_RUNTIME_STATUS),
            value("system_ui.recents_layout_initialized",
                    SettingsKeys.KEY_RECENTS_LAYOUT_PER_DISPLAY_INITIALIZED),
            value("system_ui.recents_layout_main",
                    SettingsKeys.KEY_RECENTS_LAYOUT_MAIN),
            value("system_ui.recents_layout_cover",
                    SettingsKeys.KEY_RECENTS_LAYOUT_COVER),
            value("system_ui.recents_layout_runtime_status",
                    SettingsKeys.KEY_RECENTS_LAYOUT_RUNTIME_STATUS),

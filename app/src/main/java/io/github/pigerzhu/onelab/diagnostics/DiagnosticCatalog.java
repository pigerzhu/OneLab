...
final class DiagnosticCatalog {
    static final Feature[] FEATURES = {
            ...
            feature("apps.qishui_large_screen", "Qishui Music large-screen support",
                    SettingsKeys.KEY_ENABLE_QISHUI_LARGE_SCREEN, "com.luna.music"),
            feature("apps.qishui_pad_player_layout", "Qishui Music Pad player layout",
                    SettingsKeys.KEY_ENABLE_QISHUI_PAD_PLAYER_LAYOUT, "com.luna.music"),
